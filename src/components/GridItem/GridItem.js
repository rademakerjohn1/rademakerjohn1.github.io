        ...
        <div className="card-wrap col-sm-6 col-lg-4">
            <div className="portfolio-card card">
                <div className="card-body">
                    <div><a href={props.projectDemo} target="blank" className="btn-primary"><img alt="" src={require(`${props.projectImg}`)} width="100%" className="card-img-top img-responsive" /></a></div>
